...
class ReleaseValidator:
    ...
    def validate_release_match(
        ...
        expected_album = normalize_string(expected_release.album or "")
        expected_artist = normalize_string(expected_release.artist or "")
        fetched_album = normalize_string(fetched_release_info.title or "")
        fetched_artist = normalize_string(fetched_release_info.artist or "")
