...
from ..models.search_results import SearchResult, MusicBrainzSong
        ...
        while True:
            ...
            if auto and auto_select_func:
                ...
                if selected:
                    ...
                    if selected:
                        self.console.print(f"[yellow]⚠[/yellow] No perfect match found, using first result: [white]{selected.get_display_name()}[/white]")
                    return selected
            else:
                # Get user selection
