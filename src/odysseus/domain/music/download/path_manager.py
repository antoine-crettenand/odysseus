...
from ..identity import track_titles_match
...
class PathManager:
    ...
    def get_existing_tracks(
        ...
        for track_num in track_numbers:
            ...
            title = self.download_service.sanitize_filename(track.title)
            ...
            if not found:
                ...
                for audio_file in all_audio_files:
                    ...
                    # Check if titles match (exact or conservatively fuzzy).
                    if title_normalized == file_title_normalized:
                        ...
                        found = True
                        break
                    elif track_titles_match(title_normalized, file_title_normalized):
                        existing_tracks[track_num] = audio_file
                        used_files.add(audio_file)
                        found = True
                        break
